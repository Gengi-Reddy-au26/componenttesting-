      ...
      <div className={s.info}>
        ...
        <div className="flex flex-wrap items-start">
          <div className={s.input+" w-4/12 pr-2"}>  
            ...
            <div className={s.label}>"Weight indicates how important is that criteria for your marketing campaign".</div>                            
          </div>
          <div className={s.input+" w-4/12 pr-2"}> 
          ...
          <div className={s.input+" w-4/12 pr-2"}> 
            ...
            <div className={s.label_s}>Weight</div>
            <WeightSlider axis="x" x={data.i_verified_w} onChange={(o)=>{campaignChangeHandler(o.x, 'i_verified_w')}}/> <h1>Develop. Preview. Ship. 🚀</h1>;
            <div className={s.label}>"Weight indicates how important is that criteria for your marketing campaign".</div>            
          </div>
