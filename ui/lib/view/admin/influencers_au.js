...
import {tag, percentage_tag, collab_status_tag} from '../_blocks/ui';
  ...
  const Item=(i)=>{
    ...
    const details_=(
      <div className={s.details}>
        ...
        <div className={s.data}>
          <div className={s.label}>Member Since : </div>
          <div className={s.value}> {created_at}</div>
        </div>
        <div className={s.data}>
          <div className={s.label}>Facebook : </div>
          <div className={s.value}> {facebook_link}</div>
        </div> 
        <div className={s.data}>
          <div className={s.label}>Instagram : </div>
          <div className={s.value}> {i.meta ? i.meta.instagramUsername : ''}</div>
        </div>
      </div>
    )
    let orders_list_
    ...
    return(
      <div className={s.item+' flex px-4 py-4 mb-4'}>
        ...
        <div className={s.profile_a +' pr-2'}>
          {profile_}
        </div>
        <div className={s.details_a+' pr-2'}>
          {details_}
        </div>
        <div className={s.orders_a+' pr-2'}>
          {orders_}
        </div>
        <div className={s.collabs_a+' pr-2'}>
          {collabs_}
        </div>
      </div>
    )
