...
const request = (i) => {
  ...
  let {userType, email, fullname, mobile, onek_followers, profession, industry, instagram_url, companyName, website}=i.meta
  const update = async() => {
  ...
  let fileds_ = infoFields({
    items: userType  == 'busienss' ? business_fields : influencer_fields
  })
  return(
